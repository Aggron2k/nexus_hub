...
import { useOnlineUsersList } from "@/app/hooks/useOnlineUsersList";
...
const ActiveUsersWidget = () => {
    ...
    const { onlineUserIds } = useOnlineUsersList(); // Online users emails
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                ...
                // Filter users who are online (their email is in onlineUserIds array)
