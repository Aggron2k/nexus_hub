...
const UserProfile: React.FC<UserProfileProps> = ({ currentUser, selectedUserId }) => {
            ...
            <div className="h-full bg-gray-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                                    ...
                                    {isEditing && (
                                        <div className="mt-3">
                                            <input
                                                ...
                                                className="w-full text-sm px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            />
                                        </div>
                                    )}
                                </div>
                    ...
                    <div className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <h3 className="text-lg font-medium text-gray-900 mb-4">Gyors statisztikák</h3>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <div className="text-2xl font-bold text-blue-600">
                                    {Math.floor((Date.now() - new Date(selectedUser.createdAt).getTime()) / (1000 * 60 * 60 * 24))}
                                </div>
                                <div className="text-sm text-gray-600">Napja a csapatban</div>
                            </div>
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <div className="text-2xl font-bold text-green-600">
                                    {getRoleDisplayName(selectedUser.role)}
                                </div>
                                <div className="text-sm text-gray-600">Jelenlegi szerep</div>
                            </div>
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <div className="text-2xl font-bold text-purple-600">
                                    {userPosition?.displayName || 'N/A'}
                                </div>
                                <div className="text-sm text-gray-600">Pozíció</div>
                            </div>
                        </div>
                    </div>
                </div>
